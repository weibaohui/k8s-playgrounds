...
export class WatchService {
   ...
   * @param ns ,可选
   */
  async watchChange<T extends V1Pod | V1PodDisruptionBudget | V2HorizontalPodAutoscaler | V1LimitRange | V1Node | V1ResourceQuota | V1Event | V1CronJob | V1Namespace | V1ReplicaSet | V1Deployment | V1ReplicationController | V1StatefulSet | V1Job>(list: Ref<T[]>, type: ResType, ns?: Ref<string>) {
